<!doctype html>
<!-- ESTA LINEA ES MUY IMPORTANTE YA QUE AQUI PONGO EL TIPO DE ESTRUCTURA QUE QUIERO -->
...
<head>
    ...
    <meta charset="utf-8" />
    <title>Fashzoco | Vende tu ropa - Rapido y Seguro</title>
...
<body>
            ...
            <div class="d-flex">
                ...
                <form class="app-search d-none d-md-block">
                    <div class="position-relative">
                        <input type="text" class="form-control" placeholder="Que buscas?" autocomplete="off"
                    ...
                    <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                        <div class="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="#!" class="btn btn-sm btn-soft-info"> Ver más..
                        ...
                        <div class="p-2">
                            ...
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="assets/images/zalando.png" alt="Zalando" width="40" height="40">
                                        <span>Zalando</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="assets/images/facebook.png" alt="Facebook Market" width="40" height="40">
                                        <span>Facebook Market</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#!">
                                        <img src="assets/images/milanuncios.png" alt="Milanuncios" width="40" height="40">
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">{{Auth::check()}}</span>
                            </span>
                        </span>
                    </button>
                    <!-- dropdown del admin -->
    ...
    <div class="col-12">
        <div class=" d-flex align-items-center justify-content-evenly">
            <a href="#">  <h4 class="mb-sm-0 text-primary"><img src="{{ url('assets/images/proyecto/hombre.png') }}"/> HOMBRE </i></h4></a>
            <a href="#"> <h4 class="mb-sm-0 text-primary"><img src= "{{ url('assets/images/proyecto/mujer.png') }}"/> MUJER</h4></a>
            <a href="#">  <h4 class="mb-sm-0 text-primary"><img src="{{ url('assets/images/proyecto/ninio.png') }}"/> NIÑO </h4></a>
        </div>
    </div>
</div>
    </div>
        ...
        <!-- ========== App Menu ========== -->
        <div class="app-menu navbar-menu pt-5 mb-5">
            <!-- LOGO -->
        ...
        <div class="main-content pt-5">
            ...
            <div class="page-content ">
                <div class="container-fluid ">
                    ...
                    <div class="col-6 " >
                        <h2>Recomendaciones de ASOS</h2>
                    </div>
                    </div>
<!-- PRINCIPIO DE LAS CARDS -->
                                ...
                                <div class="row">
                                    ...
                                    <div  class="col-md-2"  >
                                        ...
                                        <div class="card text-center" data-aos="flip-right">
                                            ...
                                            <img class="card-img-top img-fluid" src="{{url($value->imageUrl)}}" alt="{{$value->name}} ">
                                            <div class="card-body">
                                                <h4 class="card-title mb-2 text-primary">{{$value->brandName}}</h4>
                                                <p class="card-text mb-0">{{$value->name}} </p>
                                            </div>
                                            <div class="card-footer">
                                                <a href="javascript:void(0);" class="card-link link-success">Color: {{$value->colour}} <i class="ri-bookmark-line align-middle ms-1 lh-1"></i></a>
                                            </div>
                                        </div>
                                        <!-- FIN CARD -->
                                    </div> <!-- end col-->
...
<!-- footer -->
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © FashZoco.
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Diseño y desarrollo por Alberto Lavin
                                {{-- {{dd($ropaArray)}} --}}
                            </div>
                        </div>
                    </div>
    ...
    <!--end back-to-top-->
        ...
        <script src="{{ url('assets/libs/node-waves/node-waves.min.js') }}"></script>
        <script src="{{ url('assets/libs/feather-icons/feather-icons.min.js') }}"></script>
        <script src="{{ url('assets/js/pages/plugins/lord-icon-2.1.0.min.js') }}"></script>
        <script src="{{ url('assets/js/plugins.min.js') }}"></script>

        <script src="{{ url('/assets/libs/aos/aos.min.js') }}"></script>
        <script src="{{ url('/assets/libs/prismjs/prismjs.min.js') }}"></script>
        <script src="{{ url('/assets/js/pages/animation-aos.init.js') }}"></script>


        <script src="{{ url('/assets/libs/apexcharts/apexcharts.min.js') }}"></script>
        <script src="{{ url('assets/libs/jsvectormap/jsvectormap.min.js') }}"></script>
        <script src="{{ url('assets/libs/jsvectormap//world-merc.js') }}"></script>
