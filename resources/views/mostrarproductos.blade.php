    ...
    <div class="row p-5 d-flex justify-content-center ">
        ...
        <div class="col-md-4 px-4" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
            <div class="card card-body">
                ...
                <h6 class="mb-1">Precio: {{$productos[0]->precio}} €</h6>
                <h6 class="mb-1">Año de fabricación: {{$productos[0]->fechaFabricacion}}</h6>
                <p class="card-text text-muted mb-1">Sexo: Masculino</p>
                <p class="card-text text-muted">Cantidad: {{ $productos[0]->cantidad }}</p>
